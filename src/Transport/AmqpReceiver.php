 ...
 */
class AmqpReceiver implements BlockingReceiverInterface, MessageCountAwareInterface
{
    private $serializer;
    private $connection;
    ...
    {
        try {
            $this->connection->pull($queueName, $callback ? function (\AMQPEnvelope $amqpEnvelope, \AMQPQueue $queue) use ($callback) {
